                            ...
                            <form class="text-start" @submit.prevent="login">
                                <div class="form">
                                    <div id="username-field" class="field-wrapper input">
                                        ...
                                        <input type="email" class="form-control" placeholder="e.g test@example.com" v-model="authenticationData.email" />
                                    </div>
                                    ...
                                    <div id="password-field" class="field-wrapper input mb-2">
                                        ...
                                        <input :type="pwd_type" class="form-control" placeholder="Password" v-model="authenticationData.password" />
                                        <svg
                                            @click="set_pwd_type"
                                            xmlns="http://www.w3.org/2000/svg"
                                            width="24"
...
import {ref} from 'vue';
    ...
    const login = () => {
       store.dispatch('login', authenticationData.value);
    };
