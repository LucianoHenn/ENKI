<template>
    <div>
            ...
            <header class="header navbar navbar-expand-sm">
                <ul class="navbar-item theme-brand flex-row text-center">
                    ...
                    <li class="nav-item theme-text">
                        <router-link to="/" class="nav-link"> ENKI </router-link>
                    </li>
                </ul>
                ...
                <div class="navbar-item flex-row ms-md-auto">
                    ...
                    <div class="dropdown nav-item user-profile-dropdown btn-group">
                        <a href="javascript:;" id="ddluser" data-bs-toggle="dropdown" aria-expanded="false" class="btn dropdown-toggle btn-icon-only user nav-link">
                            <img :onerror="avatarError" :src='store.getters["auth/avatar_url"]' alt="avatar" />
                        </a>
                        <ul class="dropdown-menu dropdown-menu-right" aria-labelledby="ddluser">
                            <li role="presentation">
                                <a href="javascript:;" @click.prevent="showProfileModal = true" class="dropdown-item">
                                    <svg
                                        xmlns="http://www.w3.org/2000/svg"
                                        width="24"
                                        height="24"
                            ...
                            <li role="presentation">
                                <a href="javascript:;" @click="showChangePasswordModal = true" class="dropdown-item">
                                    <svg
                                        xmlns="http://www.w3.org/2000/svg"
                                        width="24"
                                        height="24"
        ...
        <user-profile-modal
          ...
          :is-show="showProfileModal"
        />

        <change-password-modal
          ref="changePasswordModal"
          @close-modal="showChangePasswordModal = false"
          :is-show="showChangePasswordModal"
        />
    </div>
</template>
...
<script setup>
    ...
    const avatarError = (e) => {
        e.target.src = 'https://www.gravatar.com/avatar/205e460b479e2e5b48aec07710c08d50?f=y';
    };
