...
/**
 * Class GoogleAdsKeywordperformanceDownloader
 */
class GoogleAdsKeywordperformanceDownloader extends BaseDownloader
{
    public function doDownload(ReportLogbook $request): bool
    {
        ...
        if(!$gal->getReport($identifier, $request->date_begin, $request->date_end, ['reportType' => 'KEYWORD_PERFORMANCE_REPORT'])) {
