                                    ...
                                    <div class="invoice-detail-title">
                                        <div class="invoice-logo">
                                            <div class="upload pe-md-4">
                                                ...
                                                <img
                                                    v-if="selected_file"
                                                    :src="selected_file ? selected_file : require('@/theme/assets/images/user-profile.jpeg')"
                                                    alt="profile"
                                    ...
                                    <div class="form-group mb-0">
                                        ...
                                        <div class="dropdown selectable-dropdown invoice-select d-block btn-group">
                                            <a href="javascript:;" id="ddlCurrency" class="btn dropdown-toggle btn-icon-only text-nowrap" data-bs-toggle="dropdown" aria-expanded="false">
                                                <img :src="require('@/theme/assets/images/' + selected_currency.thumb)" class="flag-width" alt="flag" />
                                            ...
                                            <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="ddlCurrency">
                                                <li v-for="(item, index) in currency_list" :key="index">
                                                    <a href="javascript:;" class="dropdown-item" @click="selected_currency = item">
                                                        <img :src="require('@/theme/assets/images/' + item.thumb)" class="flag-width" alt="flag" /> {{ item.key }}
                                                    </a>
                                                </li>
                                            </ul>
                                        </div>
...
<script setup>
    ...
    const items = ref([]);
    const selected_file = ref(require('@/theme/assets/images/cork-logo.png'));
    const params = ref({
        title: 'Cork Inc.',
        invoice_no: '#0001',
