...
<script setup>
    ...
    const initData = () => {
        if (allControls.value) {
            items.value = [
                {
                    src: require('@/theme/assets/images/lightbox-1.jpg'),
                ...
                {
                    src: require('@/theme/assets/images/lightbox-8.jpeg'),
                    title: 'This is dummy caption. It has been placed here solely to demonstrate the look and feel of finished, typeset text.',
                    description: 'Photo: Samuel Rohl',
                },
                {
                    src: require('@/theme/assets/images/lightbox-3.jpeg'),
                ...
                { src: require('@/theme/assets/images/lightbox-2.jpeg'), thumb: require('@/theme/assets/images/lightbox-2.jpeg'), title: 'This is dummy caption.', description: 'Photo: Folkert Gorter' },
                {
                    src: require('@/theme/assets/images/lightbox-14.jpeg'),
                    title: "It's a dummy caption. He who searches for meaning here will be sorely disappointed.",
                    description: 'Photo: Thomas Lefebvre',
                },
                {
                    src: require('@/theme/assets/images/lightbox-15.jpeg'),
                    title: "It's a dummy caption. He who searches for meaning here will be sorely disappointed.",
                    description: 'Photo: Thomas Lefebvre',
                },
            ];
            ...
            items.value = [
                ...
                { src: require('@/theme/assets/images/lightbox-8.jpeg') },
                { src: require('@/theme/assets/images/lightbox-3.jpeg') },
                { src: require('@/theme/assets/images/lightbox-2.jpeg') },
                { src: require('@/theme/assets/images/lightbox-14.jpeg') },
                { src: require('@/theme/assets/images/lightbox-15.jpeg') },
            ];
        }
